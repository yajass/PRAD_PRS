...
metaStat <- read.table("../raw_ss/meta_stats", stringsAsFactors=F, sep = ',', header = T)

caseNo=metaStat$cases[metaStat$author == args[1]]
ctrlNo=metaStat$controls[metaStat$author == args[1]]
